...
switch(_constructionType) do {
	case("TRENCH"): {
        _shopLookupArray = ["Land_SandbagBarricade_01_half_F", "Land_SandbagBarricade_01_F", "Land_BasaltKerb_01_pile_F", "Land_SandbagBarricade_01_hole_F", "Land_BagFence_01_long_green_F", "Land_BagFence_Round_F", "Land_BagFence_Long_F", "Land_BagFence_01_round_green_F","Land_GarbageHeap_01_F", "Land_Tyres_F", "Land_FirewoodPile_01_F", "Land_BagFence_01_corner_green_F"];
    };
    case("OBSTACLE"): {
    ...
    case("LIGHT_BUNKER"): {
        _shopLookupArray = ["Land_BagBunker_01_small_green_F", "Fort_Nest", "Land_BagBunker_Large_F", "Land_GuardTower_02_F", "Land_GuardTower_01_F", "Land_GuardBox_01_brown_F","Land_BagBunker_Tower_F"];
    };
    case("HEAVY_BUNKER"): {
    ...
    case("MISC"): {
        _shopLookupArray = ["CamoNet_BLUFOR_F", "CamoNet_BLUFOR_open_F", "CamoNet_BLUFOR_big_F", "Land_CanvasCover_02_F", "Land_CanvasCover_01_F", "Land_LampShabby_F", "Land_MedicalTent_01_NATO_generic_outer_F", "Land_MedicalTent_01_NATO_generic_inner_F","Land_Camping_Light_F", "Land_WoodenLog_F", "Campfire_burning_F", "Land_WoodenTable_02_large_F", "Land_ClothShelter_01_F", "Land_TentA_F"];
    };
    default { 
